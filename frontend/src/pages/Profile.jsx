    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {loading ? (
        ...
        <>
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Saved Opportunities</h2>
            {savedOpportunities.length > 0 ? (
              ...
              <div className="bg-gray-50 rounded-lg p-12 text-center">
                <p className="text-gray-500 text-lg mb-4">You haven't saved any opportunities yet</p>
                <a href="/opportunities" className="text-blue-600 hover:text-blue-700 font-medium">
                  Find opportunities →
                </a>
              </div>
            )}
